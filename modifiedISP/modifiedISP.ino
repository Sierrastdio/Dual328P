/*
 * This is a modified version of the ArduinoISP sketch, which it OUTPUTs an 8MHz clock on pin D9.
 *
 * -> line 89: #define LED_HB 9 -> #define LED_HB 6 
 * 
 * 이 코드는 기존 ArduinoISP 스케치를 수정한 버전으로, D9 핀에 8MHz 클럭을 출력합니다.
 *
 */
...
#define LED_HB 6  /* Now D9 is CLK so i change this to D6 */
#define LED_ERR 8
#define LED_PMODE 7
